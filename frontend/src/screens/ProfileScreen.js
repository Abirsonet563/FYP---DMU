...
function ProfileScreen({ history }) {
  //AH State variables for form inputs and messages
  ...
  const [message, setMessage] = useState("");
    ...
    //AH Implement Data object for updating user details
...
// AH implement Effect hook to handle initial data fetching
  useEffect(() => {
    if (!userDetails) {
      history.push("/login");
    } else {
  ...
  // AH implement Delete user handler
      ...
      <Col md={9}>
        ...
        {loadingOrders ? (
          ...
          <Table striped responsive className="table-sm">
            ...
            <tbody>
               {/* Map through and display orders */}
            {listorder
